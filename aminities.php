    ...
    <div class="container">
        <div class="row">
            <div class="amenities-flex">
                <div class="amenities-img animate-box" style="background-image: url(assets/images/amenities-1.jpg);">
                </div>
                ...
                <div class="amenities-img animate-box" style="background-image: url(assets/images/room-5.jpg);"></div>
                <div class="amenities-img animate-box" style="background-image: url(assets/images/amenities-2.jpg);">
                </div>
                <div class="desc animate-box">
                ...
                <div class="amenities-img animate-box" style="background-image: url(assets/images/amenities-3.jpg);">
                </div>
            </div>
        </div>
    </div>
